...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth->auth.requestMatchers("/home").authenticated().requestMatchers("/auth/login","/v3/api-docs/**","swagger-ui/**","/swagger-ui.html","/books/new").permitAll().anyRequest().authenticated())
